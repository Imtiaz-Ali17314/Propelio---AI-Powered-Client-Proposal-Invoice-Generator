...
<template>
    <div class="min-h-screen bg-slate-950 text-slate-100 flex font-sans selection:bg-indigo-500 selection:text-white">
        ...
        <!-- Sidebar -->
        <aside
            class="fixed inset-y-0 left-0 z-50 w-64 bg-slate-900/95 border-r border-slate-800/80 shrink-0 transform transition-transform duration-300 ease-out lg:static lg:translate-x-0 flex flex-col backdrop-blur-xl"
        ...
        >
            ...
            <nav class="p-4 space-y-1.5 flex-1 overflow-y-auto">
                ...
                <router-link
                    ...
                    active-class="!bg-indigo-600/15 !text-indigo-400 font-semibold ring-1 ring-indigo-500/30 shadow-sm"
                    @click="closeSidebar"
                >
            ...
            <div class="p-4 border-t border-slate-800/60 bg-slate-900/60">
        ...
        <div class="flex-1 flex flex-col min-w-0 bg-slate-950">
            <!-- Top bar -->
            <header class="h-16 bg-slate-900/80 border-b border-slate-800/80 px-4 sm:px-6 flex justify-between items-center backdrop-blur-xl sticky top-0 z-30">
                <div class="flex items-center gap-3">
                    <button
                        type="button"
            ...
            <main class="flex-1 p-4 sm:p-6 lg:p-8 overflow-x-hidden max-w-7xl w-full mx-auto">
                <slot />
            </main>
        </div>
    </div>
